                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="bookForm" action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data" onsubmit="submitForm()">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="no" name="no" value="{{ old('no') }}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="status" name="status">
                                            <option value="ready" {{ old('status') == 'ready' ? 'selected' : '' }}>Tersedia</option>
                                            <option value="borrow" {{ old('status') == 'borrow' ? 'selected' : '' }}>Dipinjam</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
